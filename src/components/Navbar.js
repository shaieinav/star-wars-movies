...
const Navbar = () => {
    ...
    function onStarFighterClick() {
        const starFighterIcon = document.querySelector('.star-fighter-icon'); //movie-nav-link
        ...
        <section className="nav">
            <Router>
                ...
                <Switch>
                    ...
                    <Route exact path='/movies/the-empire-strikes-back' component={TheEmpireStrikesBack} />
                    <Route exact path='/movies/return-of-the-jedi' component={ReturnOfTheJedi} />
                    <Route exact path='/movies/the-phantom-menace' component={ThePhantomMenace} />
                    <Route exact path='/movies/attack-of-the-clones' component={AttackOfTheClones} />
                    <Route exact path='/movies/revenge-of-the-sith' component={RevengeOfTheSith} />
                </Switch>
            </Router>
        </section>
    );
